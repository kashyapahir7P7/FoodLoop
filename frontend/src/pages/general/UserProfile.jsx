...
const UserProfile = () => {
    ...
    useEffect(() => {
        const fetchProfileData = async () => {
            try {
                // 1. Profile Data
                const profileRes = await axios.get("http://localhost:3000/api/auth/userprofile", { withCredentials: true });
                setProfile(profileRes.data);

                const followRes = await axios.get("http://localhost:3000/api/follow/my-following", { withCredentials: true });
